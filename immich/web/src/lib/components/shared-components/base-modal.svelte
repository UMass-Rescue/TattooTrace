...
>
  <div
    ...
    class="max-h-[800px] min-h-[200px] min-w-[450px] max-w-[1200px] overflow-y-auto rounded-lg bg-immich-bg shadow-md dark:bg-immich-dark-gray dark:text-immich-dark-fg immich-scrollbar"
  >
